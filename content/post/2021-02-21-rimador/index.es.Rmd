...
El resultado en forma de tabla con palabra de terminación similar nos puede ayudar a finalizar el verso que empezamos.
...
## Silabear
El *lemario* es una lista de palabras y será la base de datos principal, ahora debemos programar una función que cada palabra del fichero línea a línea y nos calcule las sílabas. Esto no me ha resultado tan fácil como pensaba, y además el resultado no ha sido perfecto.

He encontrado solo dos librerías que tengan funciones de silabeo (separar en sílabas), la primera opción con el paquete `hyphenatr`. 
...
hyphen("mordisco", hyph.pattern="es",min.length=1)
